(function (service, utils) {
    $(document).ready(function (e) {
        ...
        service.graficos.gePoblacionEdad('00',0 ,'P01', utils.graficos.graf_persona_edad); //mostrara los graficos del ubigeo
    ...
    $('#cmb_ubi').change(function () {
        ...
        service.graficos.gePoblacionEdad(ubigeo, self.cant_select, 'P01', utils.graficos.graf_persona_edad); //mostrara los graficos del ubigeo
    })
